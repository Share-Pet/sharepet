...
import { LoggedOutProfilePage } from '../components/LoggedOutProfile';
...
const ProfilePage = () => {
  ...
  const RenderContent = () => (
    ...
    </div><div className="bg-white rounded-3xl shadow-xl p-6 mb-6">
      ...
      </div><div className="bg-white rounded-3xl shadow-xl p-6">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 p-4">
      <div className="max-w-2xl mx-auto">
        { !user ? <LoggedOutProfilePage /> : <RenderContent />}
      </div>
    </div>
  );
};
